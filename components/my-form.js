...
import { MyCaption } from "./my-caption.js";
import { MyDescription } from "./my-description.js";
import { MySignaturePad } from "./my-signaturepad.js";
...
export default class MyForm extends LitElement {
  ...
  resetForm() {
    ...
    let allInputs = [
      ...this.shadowRoot.querySelectorAll(
        "my-input, my-select, my-file, my-signaturepad"
      ),
    ];
    allInputs.map((x) => {
  ...
  redraw() {
    ...
    let allInputs = [
      ...this.shadowRoot.querySelectorAll(
        "my-input, my-select, my-file, my-date, my-signaturepad"
      ),
    ];
    allInputs.map((x) => {
